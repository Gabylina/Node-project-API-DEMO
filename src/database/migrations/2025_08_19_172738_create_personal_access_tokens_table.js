...
CREATE TABLE personal_access_tokens (
    id BIGINT PRIMARY KEY GENERATED ALWAYS AS IDENTITY, -- TODO: For MySQL, use AUTO_INCREMENT (e.g., id BIGINT PRIMARY KEY AUTO_INCREMENT)
...
-- Add index for the polymorphic 'tokenable' relation
