/* migrated from config/queue.php */
...
export default {
    ...
    connections: {
        ...
        database: {
            driver: 'database',
            connection: process.env.DB_QUEUE_CONNECTION ?? null,
            table: process.env.DB_QUEUE_TABLE ?? 'jobs',
            queue: process.env.DB_QUEUE ?? 'default',
            retry_after: parseInt(process.env.DB_QUEUE_RETRY_AFTER ?? '90', 10),
            after_commit: false,
        },
        ...
        beanstalkd: {
            ...
            retry_after: parseInt(process.env.BEANSTALKD_QUEUE_RETRY_AFTER ?? '90', 10),
            block_for: 0,
            after_commit: false,
        },
        ...
        sqs: {
            ...
            suffix: process.env.SQS_SUFFIX ?? null,
        ...
        redis: {
            ...
            retry_after: parseInt(process.env.REDIS_QUEUE_RETRY_AFTER ?? '90', 10),
            block_for: null,
            after_commit: false,
        },
    },
