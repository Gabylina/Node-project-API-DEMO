...
export default {
    ...
    channels: {
        ...
        single: {
            driver: 'single',
            path: 'logs/laravel.log', // Equivalent to storage_path('logs/laravel.log') in PHP
        ...
        syslog: {
            driver: 'syslog',
            level: process.env.LOG_LEVEL ?? 'debug',
            facility: process.env.LOG_SYSLOG_FACILITY ?? 'LOG_USER', // Represents LOG_USER constant (typically 1)
            replace_placeholders: true,
        },
