...
// Apply auth middleware for all subsequent routes (projects, tasks)
router.use(requireAuth);

// Projects routes (apiResource equivalent)
...
// Tasks routes (nested within projects, apiResource equivalent)
