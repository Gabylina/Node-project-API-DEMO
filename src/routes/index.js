...
// Public Auth routes (Laravel's Route::prefix('auth')->group(...) - public part)
router.post('/auth/register', AuthController.register);
router.post('/auth/login', AuthController.login);

// Authenticated Auth routes (Laravel's Route::prefix('auth')->group(...) - protected part)
router.use('/auth', requireAuth); // Applies requireAuth to /auth/* paths defined *after* this line
router.get('/auth/me', AuthController.me);
router.post('/auth/logout', AuthController.logout);

// Routes requiring authentication (Laravel's Route::middleware('auth:sanctum')->group(...))
router.use(requireAuth); // Applies requireAuth to all paths defined *after* this line
